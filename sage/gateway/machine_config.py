...
def get_config(machine_name: Optional[str] = None) -> SAGEMachineConfig:
    ...
    # (sage-rs/sage-daemon/src/main.rs: `const PORT: u16 = 8760`) and both this default and fleet.json
    # kept the old one, so every peer address the fleet handed out pointed at a dead port. Measured
    # 2026-09-13: thor and sprout answer /health on 8760 and refuse 8750.
