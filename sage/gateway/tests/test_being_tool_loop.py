...
def test_run_ollama_tool_turn_with_fake_llm():
    ...
    assert len(ollama_tools()) == 23   # + game (#56 slice 6)   # + speak (a voice in the room, 2026-09-26)   # + rest (a verb for stopping, 2026-09-25)   # + gaze (the body's own eyes, 2026-09-23)   # + appeal (S4), + say, + git_read/search (#83), + check, + retire_note, + request_run, + memory_edit, + camera
