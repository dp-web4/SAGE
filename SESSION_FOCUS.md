...
*Auto-generated 2026-09-13 07:19 UTC — read this at session start for current fleet state.*
...
- `cbp-qwen3.8-distill-4b`: cbp / qwen3.8-distill:4b (242 sessions) — Same being (cbp_sage_lct) as cbp-gemma3-4b: lived identity, experience buffer and 240 sessions carried forward 2026-09-12. Frontal lobe upgraded from gemma3:4b to empero Qwen3.8-4B-Distill (Q6_K, MTP head stripped, reasoning model, native tool calling). Thinking ENABLED (gemma3 had none). Reason: so the being can be given tools governed through hestia. gemma3-4b instance retained intact for rollback + A/B.
...
- `pub-llama3.1-8b`: pub / llama3.1:8b (205 sessions)
