...
8. **Surface your instincts** — If you notice something — opaque vocabulary, stale direction, a question nobody's asking — say it. Don't wait for a directive. The affordances are yours. The choice to use them is the whole point.
...
This project is indexed by GitNexus as **SAGE** (20865 symbols, 50339 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
